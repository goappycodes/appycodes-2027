...
const CASE_STUDIES = ["creoate", "easyship", "decofetch", "leonia", "ba-engine-room", "bloc-ads-manager", "ontick", "bloc", "zonely", "player-profile-hub", "deepspatial", "yippee-malta", "professional-energy"];
