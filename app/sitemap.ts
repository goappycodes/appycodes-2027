...
const STATIC_PAGES: { path: string; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"]; priority: number }[] = [
  ...
  { path: "/uk/insights/", changeFrequency: "weekly", priority: 0.8 },
  { path: "/uk/insights/company-data-identity/", changeFrequency: "weekly", priority: 0.7 },
  { path: "/uk/insights/payments-ecommerce/", changeFrequency: "weekly", priority: 0.7 },
  { path: "/uk/insights/product-engineering-compliance/", changeFrequency: "weekly", priority: 0.7 },
  { path: "/testimonials/", changeFrequency: "monthly", priority: 0.6 },
  { path: "/software-project-estimator/", changeFrequency: "monthly", priority: 0.6 },
