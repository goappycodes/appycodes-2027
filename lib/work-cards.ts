...
export const WORK_CARDS: InstitutionalWorkItem[] = [
  ...
  },
  {
    ...
    title: "A course-commerce and learning platform wired into one system.",
    detail: "WordPress and WooCommerce, a Moodle LMS, Stripe deposits and Zoho CRM, tied together with Zapier automation.",
    metric: "8 yrs",
    metricLabel: "engineer & run, since 2017",
  },
  {
    href: "/case-studies/all-white-laser/",
    image: "/images/allwhitelaser-featured.png",
    client: "All White Laser",
    brand: "AllWhiteLaser",
    sector: "Medical aesthetics",
    title: "A bespoke platform that finances aesthetic machines on Direct Debit.",
    detail: "A lead-to-billing system on GoCardless Direct Debit, provider certification, and a React Native app for machine owners.",
    metric: "9 yrs",
    metricLabel: "build & run, since 2017",
  },
  {
